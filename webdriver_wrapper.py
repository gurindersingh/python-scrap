...
class WebDriverWrapper:
    def __init__(self, download_location=None):
        ...
        if os.environ.get('API_ENV') == 'local':
            self._tmp_folder = os.getcwd() + '/tmp/{}'.format(uuid.uuid4())
        else:
            '/tmp/{}'.format(uuid.uuid4())

        # self._tmp_folder = os.environ.get('API_ENV') == 'local' if os.getcwd() + '/tmp/{}'.format(uuid.uuid4()) else '/tmp/{}'.format(uuid.uuid4())

        print(self._tmp_folder)
        ...
        chrome_options.binary_location = os.getcwd() + "/lib/headless-chromium"
        ...
        body = self._driver.get('https://www.gta-homes.com/')
    ...
    def get_body(self, url):
        print('kdfnv')
        # return self._driver.execute_script("return document.body.outerHTML;")
    ...
    def close(self):
        ...
        folder = os.environ.get('APP_ENV') == 'local' if '/tmp' else os.getcwd() + '/tmp'
